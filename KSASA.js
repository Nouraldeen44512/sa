...
#users .uzr.saad1 .u-msg {
  ...
  background-image: url(https://up6.cc/2024/02/170890205576321.gif);
...
border-radius: 4px;
background-image: url(https://up6.cc/2024/02/170890202777571.gif);
...
var l_itvsaad=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr:contains('نَغــــــــــــــــم')").addClass('saad1');
        $("#users .uzr.saad1 .fitimg.u-pic").append('<img class="saad_star1" src="https://up6.cc/2024/02/170890176497841.gif">');
