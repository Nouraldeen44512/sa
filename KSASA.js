...
#users .uzr.ghzl1 .d-flex.dots {
  margin-top: 7px !important;
  margin-left: 5px;
}
#users .uzr.ghzl1 .u-msg {
  text-align: center;
...
#users .uzr.ghzl1 span.uhash {
  margin-right: 324px;
  margin-top: 24px;
  margin-left: 0px;
}
#users .uzr.ghzl1 img.co {
...
#users .uzr.ghzl1 .c-flex.fr {
  margin-left: -4px!important;
  float: left;
}
#users .uzr.ghzl1 .d-flex.fl {
  padding-right: 0px !important;
}
#users .uzr.ghzl1 .u-topic {
  margin-left: 5px;
}
#users .uzr.ghzl1 .My_star1 {
  width: 84px;
  margin-top: -67px;
  height: 80px;
}
#users .uzr.ghzl1 .My_tsor {
  width: 79px;
  margin-top: -45px;
  z-index: 0;
  margin-left: 36px;
}
#users .uzr.ghzl1 .My_vedio1 {
  float: right;
  width: 20px;
  margin-top: 0px;
  margin-right: 5px;
...
var me_user1=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr:contains('ɢнzℓ')").addClass('ghzl1');
        $("#users .uzr.ghzl1 .c-flex.fr").append('<img class="My_star1" src="https://up6.cc/2024/02/170890670461031.gif">');
	$("#users .uzr.ghzl1 .c-flex.fr").append('<img class="My_tsor" src="https://i.ibb.co/ThKHx1N/image.png">');
	$("#users .uzr.ghzl1 .c-flex.fr").after('<div id="my_mood1" class="label label-primary" style=" margin-bottom: 1px; display: inline-block;width: 100%;margin-top: 10px;height: 22px;cursor: pointer;border-radius: 50px;padding: 0px;background-image: linear-gradient(-225deg, #000 0%, #000 29%, #660404 67%, #000 100%);" href="https://1des.net/">..الأمر معقد ويد اللّه حنونة..</div>');
        ...
        $("#users .uzr.ghzl1 span.uhash, #users .uzr.ghzl1 img.co").hide(); 
        ...
        $("div#users .uzr:contains('ɢнzℓ') .My_vedio1").click(function(){
        $("#movon1").show();
        
        $('#movon1').addClass('ghzl1');
